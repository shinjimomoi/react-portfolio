  ...
  return (
      <div class="card align-center">
        <div class="description">
          ...
          <a className='img-small' href={props.item.url}><img src={props.item.imageUrl} alt="project" /></a>
        ...
        <a className="img-big" href={props.item.url}><img class="" src={props.item.imageUrl && props.item.imageUrl2} alt="project" /></a>
      </div>
  )
}
